...
|---|---|
| [get_started_imputation.ipynb](https://github.com/EDF-Lab/ts-icl/blob/main/notebooks/get_started_imputation.ipynb) | Pointwise & block missingness, covariate-aware imputation, output format, batch processing |
| [get_started_forecasting.ipynb](https://github.com/EDF-Lab/ts-icl/blob/main/notebooks/get_started_forecasting.ipynb) | Univariate forecasting, partially observed look-back, covariate-aware forecasting, batch processing |
...
TS-ICL weights and code are released under a non-commercial license, see [LICENSE](https://github.com/EDF-Lab/ts-icl/blob/main/LICENSE).
