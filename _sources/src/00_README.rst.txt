...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/TS-ICL-v1.png
   :width: 70%
   :align: center
   :alt: alt
...
Model checkpoint can be found on `TS-ICL’s Huggingface
repo <https://huggingface.co/taharnbl/TS-ICL>`__.
...
+===================================+===================================+
| `get_st                           | Pointwise & block missingness,    |
| arted_imputation.ipynb <notebooks | covariate-aware imputation,       |
| /get_started_imputation.ipynb>`__ | output format, batch processing   |
+-----------------------------------+-----------------------------------+
| `get_star                         | Univariate forecasting, partially |
| ted_forecasting.ipynb <notebooks/ | observed look-back,               |
| get_started_forecasting.ipynb>`__ | covariate-aware forecasting,      |
|                                   | batch processing                  |
+-----------------------------------+-----------------------------------+
...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/fevbench.png
   :width: 80%
   :align: center
   :alt: alt
...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/forecast-GFC17-covar.png
   :width: 80%
   :align: center
   :alt: alt
...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/Time-Benchmark.png
   :width: 60%
   :align: center
   :alt: alt
...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/fm-impute-bench.png
   :width: 80%
   :align: center
   :alt: alt
...
.. figure:: https://raw.githubusercontent.com/EDF-Lab/ts-icl/main/docs/contents/impute-covid19-energy.png
   :width: 80%
   :align: center
   :alt: alt
...
-  `Marc Héry <https://github.com/MarHery>`__
